...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "AMXyiEwzyC1356DaxY6D"; 
	private final static String CLIENT_SECRET = "MtGLpCjcyW";
	private final static String REDIRECT_URI = "http://localhost:8081/main/callback";
